      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-20 pl-8 pr-8 mb-10">
        ...
        {feedsToDisplay?.map((feed: Feed, index: number) => {
          ...
          return (
            ...
            >
              <Card className="w-[480px] h-[520px] shadow-sm shadow-gray-600 cursor-pointer hover:shadow-md transition-shadow duration-200 flex flex-col">
                ...
                <CardFooter className="p-2 ml-4 mt-auto">
                  Generated By: {"AI ✨"}
                </CardFooter>
              </Card>
            </div>
